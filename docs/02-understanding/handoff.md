...
- M1 close-out record (../01-spine/milestone.md Integration notes): cold start proven (0.417s launch→checkin cold, Debug); **criteria 2/4 (real-meeting dogfood, zero-network-during-meeting) closed by owner decision without machine evidence** — M2's own exit criteria (real-meeting artifacts, diarization live checks) will re-prove them incidentally; treat the first M2 dogfood meeting as also retiring that debt.
