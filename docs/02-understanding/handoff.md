...
Slice 2 is **committed, not shipped**. Critic, un-anchored verifier, the decisions, and a second un-anchored fix-review are all done (slice doc notes 25–28); only the author-side items remain:
