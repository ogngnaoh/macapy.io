...
| 2 | ProviderKit: OpenAI-compatible streaming client, endpoint profiles + quirks, Keychain, spend ledger + cap, Providers/Spend settings UI, fake-server tests ([plan/record](./slice-02-providerkit.md)) | **active** |
