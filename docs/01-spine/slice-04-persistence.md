...
- [ ] Fix verifier residual (d): make SegmentWriter end-of-meeting flush deterministic (no reliance on actor enqueue order); remove scheduling-slack hacks from its test
