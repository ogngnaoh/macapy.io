...
- [ ] **BLOCKER on live check 5 (fix in progress):** sleep-then-yield pacing fix + fed-audio clamp + excludedNegative reporting + chunk-level pacing-precision test (red against old code first)
